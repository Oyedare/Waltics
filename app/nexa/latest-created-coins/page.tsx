...
function useLatestCreatedCoins() {
  return useQuery<LatestCreatedCoin[]>({
    queryKey: ["nexa", "latest-created-coins"],
    queryFn: async () => {
      const res = await fetch(
        "/api/proxy/external-api/insidex/coins/latest-created",
        {
...
export default function NexaLatestCreatedCoinsPage() {
  const { data, isLoading, isError, error } = useLatestCreatedCoins();
      ...
      <div className="mx-auto space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <DownloadButton
              elementId="latest-created-coins-table"
              filename="latest-created-coins-table.png"
              size="sm"
            />
          </div>
        </div>
        ...
        {isLoading ? (
          <div id="latest-created-coins-table">
            <Table>
              <TableHeader>
                <TableRow>
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          {/* <DownloadButton
                            elementId={`latest-coin-row-${c._id || c.id}`}
                            filename={`latest-created-coin-${(
                              c.symbol || "unknown"
