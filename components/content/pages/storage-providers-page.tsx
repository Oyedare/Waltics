    ...
    <div className="p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6 h-full overflow-y-auto">
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          <Card id="total-nodes-card">
            <CardHeader className="pb-2 flex flex-row items-center justify-between">
              <CardTitle className="text-sm font-medium">Total Nodes</CardTitle>
              <DownloadButton
                elementId="total-nodes-card"
                filename="total-nodes.png"
                size="sm"
                showText={false}
              />
            </CardHeader>
          ...
          <Card id="avg-commission-card">
            <CardHeader className="pb-2 flex flex-row items-center justify-between">
              <CardTitle className="text-sm font-medium">
                Avg Commission
              </CardTitle>
              <DownloadButton
                elementId="avg-commission-card"
                filename="avg-commission.png"
                size="sm"
                showText={false}
              />
            </CardHeader>
        ...
        {/* Table */}
        <Card id="storage-providers-export">
          <CardHeader>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  className="h-9 sm:h-10 px-3 rounded-md border border-border text-sm cursor-pointer inline-flex items-center gap-2 hover:bg-accent exclude-from-export"
                  onClick={() => {
                            ...
                            <div className="flex items-center gap-2">
                              {v.imageUrl ? (
                                ...
                                <img
                                  src={v.imageUrl}
                                  alt={v.validatorName}
                                  className="h-6 w-6 rounded-full object-cover exclude-from-export"
                                />
                              ) : (
