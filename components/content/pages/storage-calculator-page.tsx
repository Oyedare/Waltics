...
import { Calculator, DollarSign, Coins, Clock, HardDrive } from "lucide-react";
    ...
    <div className="space-y-4 sm:space-y-6 p-3 sm:p-4 lg:p-6 h-full overflow-y-auto">
      ...
      <div className="space-y-1 sm:space-y-2">
        ...
        <p className="text-xs sm:text-sm text-muted-foreground">
          Calculate the cost of storing data on the Walrus network for different
          durations
        </p>
      </div>
            ...
            <div className="sm:hidden space-y-3">
              <div className="p-3 border rounded-lg space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">1 Epoch (14 days)</span>
                </div>
              ...
              <div className="p-3 border rounded-lg space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">1 Month (30 days)</span>
                </div>
                <div className="space-y-1">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">WAL Cost:</span>
              ...
              <div className="p-3 border rounded-lg space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium">1 Year (365 days)</span>
                </div>
                <div className="space-y-1">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">WAL Cost:</span>
